...
//       {/* Orders */}
//       <div className="accordion w-full font-medium md:w-1/2 border border-gray-900 p-6 bg-dark-blue rounded-md">
  ...
  return (
    <div className="sales-container flex flex-col items-center">
      ...
      {loading ? (
        ...
        <div className="accordion w-full font-medium md:w-1/2 border border-gray-900 p-6 bg-dark-blue rounded-md">
          {orders.length === 0 ? (
            <p className="text-red text-xl text-center">No Orders at the selected dates</p>
          ) : (
            orders.map((order, index) => (
              <div
                key={order._id}
