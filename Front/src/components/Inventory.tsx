...
//     try {
//       const response = await axios.get("https://pos-backend-on9v.onrender.com/products");
...
//     try {
//       await axios.delete(`https://pos-backend-on9v.onrender.com/products/${productId}`);
...
//   return (
//     <div className="main-container flex  md:flex-row justify-between items-start border border-red-600">
//       <div className="col-1 flex flex-col items-center border border-green-600 mr-3 gap-2 p-4">
...
//       <div className="col-2 border border-blue-600">
...
//   return (
//     <div className="main-container flex flex-col md:flex-row justify-between items-start border border-red-600">
//       <div className="col-1 w-full md:w-1/4 flex flex-col items-center border border-green-600 mr-3 gap-2 p-4">
//         <h2 className="mb-4 text-2xl font-semibold">Add New Item</h2>
//         <label className="mb-2">
//           Item name:
//           <input
...
//         </label>
//         <label
//           className="flex  cursor-pointer appearance-none justify-center rounded-md border border-dashed border-gray-300 px-3 py-6 text-sm transition hover:border-gray-400 focus:border-solid focus:border-blue-600 focus:outline-none focus:ring-1 focus:ring-blue-600 disabled:cursor-not-allowed  disabled:opacity-75"
//           tabindex="0"
//         >
//           <span htmlFor="photo-dropbox" className="flex items-center space-x-2 bg-">
...
//       <div className="col-2 w-full md:w-3/4 border border-blue-600">
//         <h2 className="text-2xl font-semibold mb-4">Items List</h2>
//         <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 3xl:grid-cols-5 gap-8">
//           {products.map((product) => (
//             <div key={product._id}>
...
const AddNewProducts = () => {
  ...
  return (
    <div className="main-container flex flex-col md:flex-row justify-between items-start">
      <div
        className="sticky top-2 col-1 w-full md:w-1/4 flex flex-col items-center mr-3 gap-2 p-4"
        onDrop={handleDrop}
