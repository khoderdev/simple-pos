...
const AddNewProducts = () => {
  ...
  const [editProduct, setEditProduct] = useState<string | null>(null);
  const [viewMode, setViewMode] = useState<"grid" | "rows">("grid"); // State for view mode
  ...
  // Toggle view mode between grid and rows
  const toggleViewMode = () => {
    setViewMode((prevMode) => (prevMode === "grid" ? "rows" : "grid"));
  };
