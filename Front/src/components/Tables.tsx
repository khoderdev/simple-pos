...
// // //   const [productNames, setProductNames] = useState<ProductNameMap>({});
// // //   const navigate = useNavigate();
// // //   // Fetch product names when component mounts
// // //   useEffect(() => {
// // //     fetchProductNames();
// // //   }, []);
...
// // //   const editOrderItem = (orderId: string, tableId: string) => {
// // //     navigate(`/pos/edit-order/${orderId}/${tableId}`);
// // //   };
...
// // //                       <td className="p-2">
// // //                         <button
// // //                           onClick={() => editOrderItem(order._id, item._id)}
// // //                           className="bg-blue-500 px-2 py-1 text-white rounded-lg hover:bg-blue-600 transition-colors duration-300"
// // //                         >
// // //                           Edit
// // //                         </button>
// // //                       </td>
...
// //     }
// //     const orders = await response.json();
// //     console.log("Fetched orders for table", tableNumber, ":", orders);
// //     return orders;
// //   } catch (error: any) {
// //     console.error("Error fetching orders:", error.message);
// //     return [];
...
// //   // Fetch orders for the selected table when in edit mode
// //   useEffect(() => {
// //     const fetchOrdersForSelectedTable = async () => {
// //       if (selectedTable) {
// //         const fetchedOrders = await fetchOrders(selectedTable.split(" ")[1]);
// //         setOrders(fetchedOrders);
// //       }
// //     };

// //     if (editMode && selectedTable) {
// //       fetchOrdersForSelectedTable();
// //     }
...
// //       {/* Edit order button */}
// //       <button
// //         onClick={() => navigate(`/pos/edit-order/${table.split(" ")[1]}`)}
// //         className="mt-4 w-full px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition-colors duration-300"
// //       >
// //         Edit Order
// //       </button>
// //       {/* Close order button */}
...
// // const fetchOrders = async (tableNumber: string): Promise<Order | null> => {
// //   try {
// //     const response = await fetch(
// //       `http://localhost:5200/orders/table/${tableNumber}`
// //     );
...
// //     // Find the order with the highest ID
// //     const latestOrder = orders.reduce((prevOrder, currentOrder) =>
// //       prevOrder._id > currentOrder._id ? prevOrder : currentOrder
// //     );
...
//                 navigate(
//                   `/pos/edit-order/${table.split(" ")[1]}/${order._id}/items`
//                 );
//               }}
//               className="mt-4 w-full px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition-colors duration-300"
//             >
...
const fetchOrders = async (tableNumber: string): Promise<Order[]> => {
  try {
    ...
    return [latestOrder]; // Return the latest order in an array
  } catch (error: any) {
    console.error("Error fetching orders:", error.message);
    return [];
  }
