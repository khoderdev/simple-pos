import { pipe, filter, groupBy, prop, curry, reduce, chain,  indexBy, mapObjIndexed, map } from 'ramda';
import {
  eachDayOfInterval,
  eachHourOfInterval,
  endOfDay,
...
import { View, ClosedOrder, ClosedOrderItem, Item } from '../../types';
import { medianByProp, sumByProp } from '../../utils/ramda';
