...
//       const response = await axios.put(`${BASE_URL}/orders/update/${orderId}`, {
//         items: cart.map((item) => ({
//           productId: item._id,
//           quantity: item.quantity,
//           price: item.price,
...
//       console.log("Order updated successfully:", updatedOrderDetails);
//       setOrderSummary(updatedOrderDetails);
//       setIsModalOpen(true);

//       if (updatedOrderDetails.items && updatedOrderDetails.items.length > 0) {
//         const productId = updatedOrderDetails.items[0].product;
//         await deductProductQuantities(cart, productId, setProducts, products);
//       } else {
//         console.error("Error: No items found in updated order details.");
//       }
//     } catch (error) {
...
//               <th className="hidden sm:flex py-2 px-4">Actions</th>
//             </tr>
//           </thead>
//           <tbody>
//             {cart.map((cartProduct) => (
//               <tr key={cartProduct._id} className="border-t border-gray-500">
...
//                       onClick={() => decrementCartItemQuantity(cartProduct._id)}
//                     >
//                       -
//                     </button>
//                     <input
...
//                       onClick={() => incrementCartItemQuantity(cartProduct._id)}
//                     >
//                       +
//                     </button>
//                   </div>
...
//             {totalAmount.toLocaleString()} L.L
//           </span>
//         </div>
//         <button
//           onClick={orderId ? updateOrder : placeOrder}
//           className="ml-4 px-6 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition-colors duration-200"
//         >
...
//     // Fetch order items for a specific table and order ID
//     const fetchOrderItems = async () => {
//       setIsLoading(true);
//       try {
//         const response = await axios.get(`${BASE_URL}/orders/table/${tableId}/${orderId}`);
//         const fetchedOrder = response.data[0]; // Assuming only one order is returned
//         const orderItems = fetchedOrder.items.map((item: { product: any; quantity: any; totalAmount: any; }) => ({
//           ...item.product,
//           quantity: item.quantity,
//           totalAmount: item.totalAmount,
//         }));
//         setCart(orderItems);
//         setTotalAmount(fetchedOrder.totalAmount);
//       } catch (error) {
...
//                     orderId ? (
//                       <button
//                         className="bg-yellow-500 px-2 sm:px-4 py-1 sm:py-2 rounded hover:bg-yellow-600 text-white"
//                         onClick={updateOrder}
//                       >
//                         Update Order
//                       </button>
